...
const APP_SHELL = [
  ...
  './body-map/details/head-front-hitmap.png?v=1',
  './body-map/details/head-back-hitmap.png?v=1',
  './body-map/details/shoulder-right-hitmap.png?v=1',
  './body-map/details/hip-right-hitmap.png?v=1',
  './body-map/details/knee-front-right-hitmap.png?v=2',
  './body-map/details/knee-back-right-hitmap.png?v=1',
  './body-map/details/lower-back-hitmap.png?v=2',
  './body-map/details/foot-dorsal-right-hitmap.png?v=1',
  './body-map/details/foot-plantar-right-hitmap.png?v=1',
  './body-map/details/glute-right-hitmap.png?v=1',
  './body-map/details/abdomen-hitmap.png?v=1',
]
