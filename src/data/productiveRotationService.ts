...
export class ProductiveRotationService {
  ...
  private async syncEpoch(state:ConcreteRotationState,context:EpochContext,transport:GoogleSheetsSingleWriterTransport):Promise<void>{
