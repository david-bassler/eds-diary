...
import { NO_REGION, TAP_MAX_MOVEMENT, KNEE_MAPS, kneeDetailLabel } from './KneeDetailSelector.meta'
import type { RegionDefinition, HitMapData } from './KneeDetailSelector.meta'
