...
import { NO_REGION, TAP_MAX_MOVEMENT, HAND_DETAIL_MAPS, handDetailLabel } from './HandDetailSelector.meta'
import type { RegionDefinition, HitMapData } from './HandDetailSelector.meta'
    ...
    >
      <div className="hand-detail-selector__heading">
        <div>
          ...
          <span>Optional · Fingerglieder und Gelenke einzeln auswählbar</span>
        </div>
      ...
      <div
        ...
        role="img"
        aria-label={`${map.surfaceLabel}, Fingerglieder und Fingergelenke antippen`}
      >
        <img
