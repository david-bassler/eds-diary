...
import { NO_REGION, TAP_MAX_MOVEMENT, FOOT_DETAIL_MAPS, footDetailLabel } from './FootDetailSelector.meta'
import type { RegionDefinition, HitMapData } from './FootDetailSelector.meta'
