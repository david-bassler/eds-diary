...
import { NO_REGION, TAP_MAX_MOVEMENT, HEAD_DETAIL_MAPS, headDetailLabel } from './HeadDetailSelector.meta'
import type { RegionDefinition, HitMapData } from './HeadDetailSelector.meta'
